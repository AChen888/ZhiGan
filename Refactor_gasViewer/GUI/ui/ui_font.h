...
extern GUI_CONST_STORAGE GUI_FONT GUI_FontC64x64;

extern GUI_CONST_STORAGE GUI_FONT GUI_FontHZ64x64;
...
struct t_ascii_lib {
	unsigned short libsize;
	unsigned char* pdata;
};

extern const struct t_ascii_lib ascii_16X08_lib;
extern const struct t_ascii_lib ascii_24X12_lib;
extern const struct t_ascii_lib ascii_32X16_lib;

#define CHAR_DOT_16x16	1
#if CHAR_DOT_16x16
