...
ui_widgets_t *TestDacWidgetsList[1] = {0};
...
//创建控件
static void TestDacWin_Init ( void )
{
...
static void TestDacWin_Deinit ( void )
{
}

static void TestDacWin_Paint ( void )
{
	
}

static void TestDacWin_Update ( void )
{
	
}

static void TestDacWin_TimerCallback ( void )
{
	//	char string[16];
...
//事件回调函数
static void TestDacWin_Callback ( void *parg )
{
...
* 创建第一个窗口
*/
void TestDacWin_Create ( void *parg )
{
	( void ) parg;

	ui_window_create ( ( ui_window_t * ) parg, &TestDacWindow, TestDacWin_Callback );
